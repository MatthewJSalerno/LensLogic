...
docker run --rm \
  ...
  -v /path/to/organized:/data/dest \
  -v /path/to/appdata:/appdata \
  lenslogic python3 lenslogic_engine.py --move
```
...
docker run --rm \
  ...
  -v /path/to/organized:/data/dest \
  -v /path/to/appdata:/appdata \
  lenslogic python3 lenslogic_engine.py --copy
```
